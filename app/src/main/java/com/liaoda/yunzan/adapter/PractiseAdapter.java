...
public class PractiseAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
    private List<String> tags = new ArrayList<>();
    public PractiseAdapter(@Nullable List<String> data, List<String> tag) {
    ...
    protected void convert(BaseViewHolder helper, String item) {
        if(helper.getAdapterPosition() == 1) {
            helper.setText(R.id.tv_favorite,"猜你喜欢");
