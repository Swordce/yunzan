...
public class SponsorFragment extends Fragment {
    ...
    private SponsorAdapter homeAdapter;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        headerView3 = getLayoutInflater().inflate(R.layout.sponsor_header,(ViewGroup)rvSubject.getParent(),false);
        ...
        tags.add("传单派发");
        tags.add("产品促销");
        homeAdapter = new SponsorAdapter(testList,tags);
